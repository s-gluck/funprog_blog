...
#SG: I tried to re-organize the codes after our meeting with Daniel. They all work, we'll just need to be able to describe them for our blog post. Also I found out Method2 and Method3 are the same, DA just assigned a nested function from Method3 into its own function in Method2. 
